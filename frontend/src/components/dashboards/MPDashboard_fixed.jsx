              ...
              <div className="w-full md:w-1/2 p-6 bg-slate-900 text-emerald-400 font-mono text-xs overflow-y-auto shadow-inner flex flex-col gap-4">
                ...
                <div className="bg-emerald-900/30 p-4 rounded border border-emerald-500/50 mb-2">
                  ...
                  <p className="text-white text-sm leading-relaxed">
                    {selectedExifProject.village ? `${selectedExifProject.village}, ` : ""}
                    {selectedExifProject.taluka ? `${selectedExifProject.taluka}, ` : ""}
                    {selectedExifProject.district || "Warangal"}, {selectedExifProject.state || "Telangana"}
                ...
                <div className="bg-slate-800 p-3 rounded border border-slate-700">
                  <div className="text-white font-bold mb-1 border-b border-slate-600 pb-1">
                    GPS METADATA
                    RAW BASELINE COORDINATES
                    GPS METADATA RAW BASELINE COORDINATES
                  </div>
                  ...
                  {liveProjects.map((p) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-end gap-2">
                        <div
                          className={`px-3 py-1 rounded-full text-xs font-bold ${p.status !== "PENDING_DC_APPROVAL" ? "bg-emerald-100 text-emerald-800" : "bg-amber-100 text-amber-800"}`}
                        >
                          {p.status}
                        </div>
                        {p.status !== "PENDING_DC_APPROVAL" && (
                          <button
                            onClick={() => {
                          ...
                          >
                            ...
                            Verify EXIF Baseline
                            Verify Day-0 Location
                            Verify EXIF Baseline Verify Day-0 Location
                          </button>
                        )}
                      </div>
                    </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl space-y-4">
                  <h4 className="text-sm font-bold text-slate-800 uppercase tracking-wide">Target Location</h4>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-slate-700 mb-1">Village/Ward</label>
                      <label className="block text-sm font-medium text-slate-700 mb-1">
                        Village/Ward
                      </label>
                      <input
